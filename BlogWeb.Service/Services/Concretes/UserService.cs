...
namespace BlogWeb.Service.Services.Concretes
{
    ...
    public class UserService : IUserService
    {
        ...
        private readonly IIamgeHelper ıamgeHelper;
        private readonly ClaimsPrincipal _user;

        public UserService(IUnitOfWork unitOfWork, UserManager<AppUser> userManager, IHttpContextAccessor httpContextAccessor, IMapper mapper, RoleManager<AppRole> roleManager, SignInManager<AppUser> signInManager,IIamgeHelper ıamgeHelper)
        {
        ...
        private async Task<Guid> UploadImageForUser(UserProfileDTO userProfileDto)
        {
            ...
            var imageUpload = await ıamgeHelper.Upload($"{userProfileDto.FirstName}{userProfileDto.LastName}", userProfileDto.Photo, ImageType.User);
